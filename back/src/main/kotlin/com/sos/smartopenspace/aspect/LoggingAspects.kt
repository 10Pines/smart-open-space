...
class LoggingAspects {
  ...
  @Before(
    "@annotation(com.sos.smartopenspace.aspect.LoggingExecution) " +
  ...
  fun logBefore(joinPoint: JoinPoint) {
    ...
    val paramNames =
      getSignatureParameterNames(joinPoint).joinToString(STR_SEPARATOR)
  ...
  @AfterReturning(
    pointcut = "@annotation(com.sos.smartopenspace.aspect.LoggingExecution)",
    returning = "result"
  )

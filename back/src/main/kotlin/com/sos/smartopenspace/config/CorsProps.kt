...
class CorsProps(
    ...
    fun corsAllowedOrigins(): Array<String> = getArrayFromStringRaw(corsAllowedOrigins).also {
        logArrayValue("Allowed CORS origins", it)
    }

    fun corsSocketOrigins(): Array<String> = getArrayFromStringRaw(corsAllowedSocketOrigins).also {

...
fun generateTalkBody(
  name: String = "asdf",
  description: String = "a generic description",
  aMeeting: String = "http://aGenericLink.com"
): String {
  return """
            {
                "name": "${name}",
...
fun anOpenSpaceWith(
  ...
  val openSpace =
    anOpenSpace(talks = mutableSetOf(talk), slots = slots, rooms = rooms)
...
fun aUser(
  ...
  talks: MutableSet<Talk> = mutableSetOf(),
  userEmail: String = "apprentices@sos.sos"
): User {

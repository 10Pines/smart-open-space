    ...
    return (
        ...
        >
            {label && (
                <label
                    style={{
                        ...
                        color: isFocused || value ? (primary ? customTheme.global.colors.primary.light : "white") : (primary ? '#666' : "lightgrey"),
                        backgroundColor: isFocused || value ? (primary ? 'white' : customTheme.global.colors.primary.light) : 'transparent',
            ...
            <Input
                ...
                style={{
                    width: '100%',
                    border: `1px solid ${primary ? customTheme.global.colors.primary.light : customTheme.global.colors.background.light}`,
                    padding: '12px 16px',
